                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-6 item">
                                    <div class="f-item about">
                                        ...
                                        <p>
                                            Every once in a while we will be bothering you with a newsletter or two. We want to make you take full advantage of everything we have to offer.
                                        </p>
                                        <p class="text-italic">
                                            Please leave us your email to receive updates, news and support*
                                        </p>
                                        <div class="subscribe">
                                            <form action="#">
